---
title: 'AWS IAM Policies and Roles: Understanding the Differences'
date: '2024-08-17'
tags: ['aws', 'iam', 'policy', 'cloud', 'security']
summary: 'A look at the differences between AWS IAM policies and roles, and how to use them effectively.'
images:
  [
    '/static/images/banners/blog_art1.jpg',
  ]
authors: ['default']
---
